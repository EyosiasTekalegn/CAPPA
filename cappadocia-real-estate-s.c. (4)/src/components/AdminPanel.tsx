  ...
  return (
    <div className="relative w-full">
      ...
      >
        ...
        <ChevronDown
          className={`w-4 h-4 ml-2 flex-shrink-0 transition-transform duration-200 text-zinc-400 ${
          ...
          {activeAdminTab === "dashboard" && !isSales && (
            <div className="space-y-6 animate-in fade-in duration-200">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-100 dark:border-zinc-800 pb-4">
                <div>
                  <h3 className="font-sans font-extrabold text-2xl tracking-tight text-black dark:text-zinc-100">
                    Dashboard Overview
                  </h3>
                  <p className="text-sm text-zinc-600 dark:text-zinc-400 font-sans">
          ...
          {activeAdminTab === "properties" && (
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-bold font-serif text-lg text-black dark:text-zinc-100">
                    Property Portfolios
                  </h3>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setPropCompletionPercentage(Number(e.target.value))
                          }
                      ...
                      <div className="sm:col-span-2">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 bg-zinc-50 dark:bg-zinc-900/40 p-4 rounded-xl border border-zinc-200 dark:border-zinc-800/60 mb-4">
                          {(allAmenities || []).map((amenity) => {
                            const isChecked = (propAmenities || []).includes(
                              amenity
                            );
                            return (
                              <button
                        ...
                        <div>
                            ...
                            <button
                              onClick={(e) => {
                                ...
                                setPropUnitsInfo([
                                  ...
                                  {
                                    id: `unit-${Date.now()}`,
                                    name: `Unit Type ${propUnitsInfo.length + 1}`,
                                    bedrooms: 2,
                                    bathrooms: 2,
                                    areaSqm: 80,
                                  },
                          ...
                          <div className="space-y-3 mt-4">
                            {propUnitsInfo.map((unit, idx) => (
                              <div
                                key={unit.id}
                                className="grid grid-cols-2 md:grid-cols-5 gap-3 bg-white dark:bg-zinc-950 p-4 rounded-xl border border-zinc-200 dark:border-zinc-800 relative pt-8"
                              >
                                <button
                                  onClick={(e) => {
                                    e.preventDefault();
                                    setPropUnitsInfo(
                                      propUnitsInfo.filter((_, i) => i !== idx)
                                    );
                                  }}
                                  className="absolute top-2 right-2 text-zinc-400 hover:text-red-600 outline-none transition cursor-pointer"
                                >
                                ...
                                <div className="col-span-2">
                                  ...
                                  <input
                                    ...
                                    value={unit.name}
                                    onChange={(e) => {
                                      const list = [...propUnitsInfo];
                                      list[idx].name = e.target.value;
                                      setPropUnitsInfo(list);
                                    }}
                                    className="w-full p-2.5 text-xs rounded-lg border border-zinc-200 dark:border-zinc-800 bg-[#F9F9FB] dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 outline-none focus:ring-2 focus:ring-red-600"
                                  />
                                </div>
                                <div>
                                  <label className="block text-[9px] font-bold uppercase tracking-widest text-zinc-500 mb-1">
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => {
                                      const list = [...propUnitsInfo];
                                      list[idx].bedrooms = Number(e.target.value);
                                      setPropUnitsInfo(list);
                                    }}
                                    className="w-full p-2.5 text-xs rounded-lg border border-zinc-200 dark:border-zinc-800 bg-[#F9F9FB] dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 outline-none focus:ring-2 focus:ring-red-600"
                                  />
                                ...
                                <div>
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => {
                                      const list = [...propUnitsInfo];
                                      list[idx].bathrooms = Number(e.target.value);
                                      setPropUnitsInfo(list);
                                    }}
                                    className="w-full p-2.5 text-xs rounded-lg border border-zinc-200 dark:border-zinc-800 bg-[#F9F9FB] dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 outline-none focus:ring-2 focus:ring-red-600"
                                  />
                                ...
                                <div>
                                  ...
                                  <input
                                    ...
                                    onChange={(e) => {
                                      const list = [...propUnitsInfo];
                                      list[idx].areaSqm = Number(e.target.value);
                                      setPropUnitsInfo(list);
                                    }}
                                    className="w-full p-2.5 text-xs rounded-lg border border-zinc-200 dark:border-zinc-800 bg-[#F9F9FB] dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 outline-none focus:ring-2 focus:ring-red-600"
                                  />
                      ...
                      <div className="sm:col-span-2 grid grid-cols-1 gap-4 bg-zinc-50 dark:bg-zinc-900/40 p-5 rounded-2xl border border-zinc-200 dark:border-zinc-800/60 mt-2 mb-4">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) => setPropVirtualTourTitle(e.target.value)}
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="text-[9px] font-mono font-bold uppercase px-2.5 py-0.5 rounded-sm shadow-sm bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300">
                            {proj.subCity}
                          </span>
                        </div>
                        <h4 className="font-bold text-sm mt-1.5 text-black dark:text-zinc-100">
                          {proj.title}
                        </h4>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs mt-1 max-w-md text-zinc-700 dark:text-zinc-300">
                          {ad.content}
                        </p>
                      ...
                      >
                        ...
                        {m.replyText && (
                          <div className="mt-4 pl-4 border-l-2 border-[#003B95]/40 dark:border-blue-500/30">
                            ...
                            <div className="p-4 rounded-xl text-xs leading-relaxed bg-blue-50/20 dark:bg-blue-950/10 text-zinc-800 dark:text-zinc-200 border border-blue-100/20 dark:border-blue-900/10">
                              {m.replyText}
                            </div>
                          </div>
                        )}
                                  ...
                                  try {
                                    const response = await fetch(
                                      "/api/send-reply",
                                      {
                                        ...
                                        body: JSON.stringify({
                                          to: m.email,
                                          subject: `Reply to your inquiry about ${
                                            m.propertyTitle || "our property"
                                          }`,
                                    ...
                                    if (!response.ok) {
                                      ...
                                      showAlert(
                                        "Email Sent",
                                        `Your reply has been sent to ${m.email}.`
                                      );
                                    }
                                  } catch (err) {
                                    ...
                                    showAlert(
                                      "Network Error",
                                      "Could not connect to the email service. The reply was saved locally."
                                    );
                                  }
                                }}
                      ...
                      <AdminCustomSelect
                        ...
                        onChange={(val) => {
                          if (currentRole === "Manager" && val !== "Sales") {
                            showAlert(
                              "Permission Denied",
                              "Managers can only assign the Sales role."
                            );
                            return;
                          }
                          setUserRole(val);
